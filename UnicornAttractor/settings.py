...
SECRET_KEY = 'jvp+uziok55xxac(ituzb3q!zsd5b!o_0n!s+pkofxx(uc&k&d'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = [os.environ.get('C9_HOSTNAME'), 'full-stack-framework.herokuapp.com', '.amazonaws.com']
